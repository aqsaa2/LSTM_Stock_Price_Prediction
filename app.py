...
import os
import matplotlib
matplotlib.use('Agg')  # Set backend to Agg for server compatibility
...
def index():
    if request.method == 'POST':
        ...
        if not stock:
            stock = 'OGDC.KA'  # Default stock if none is entered
        ...
        ax1.legend()
        ema_chart_path = "static/expma_20_50.png"
        ...
        ax2.legend()
        ema_chart_path_100_200 = "static/expma_100_200.png"
        ...
        # Rendered template with charts and dataset
